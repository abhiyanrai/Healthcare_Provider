...
// import { getReportByIdApi, getSinglePatientDetailsById } from "../../Apis";
import { getSinglePatientDetailsById , getReportByIdApi, getConsultationsApiById} from "../../../Apis/healthcareProvider";
import moment from "moment/moment";
import Loader from "../../Components/common/Errors/loader/Loader";
import { checkBillingApi, getConsultationById } from "../../../Apis";
...
const ExaminationpReports = () => {
  ...
  console.log(kineLeft, kineRight, "kinerignidf");
  ...
  console.log(treatAk, treatMk, "treatmana", treatAkMk);
  console.log(dataReports, "datare[psr");
            ...
            <div className="row position-relative">
              <div className="position-absolute">
                ...
                >
                  ...
                  <button
                    className="btn btn-sm btn-primary top-2 position-absolute end-0"
                    style={{ marginRight: "215px", marginTop: "2px" }}
                    onClick={handlePrint}
                  >
                    Print
                  </button>
                        ...
                        <table className="table table-borderless tb_td ">
                          <thead>
                            ...
                            <tr className="d-flex">
                              ...
                              <td className="pt-0 pb-0">{patinetData?.fileNo}</td>
                            </tr>
                            <tr className="d-flex">
                              <td className="pt-0 pb-0 min-w-100">
                                <strong>Name:</strong>
                              </td>
                              <td className="pt-0 pb-0">{patinetData?.salutation +
                  " " +
                  patinetData?.firstName +
                  " " +
                  patinetData?.lastName}</td>
                            </tr>
                            <tr className="d-flex">
                              <td className="pt-0 pb-0 min-w-100">
                                <strong>D.O.B:</strong>
                              </td>
                              <td className="pt-0 pb-0">{moment(patinetData?.dob).format("DD/MM/YYYY")}</td>
                            </tr>
                            <tr className="d-flex">
                              <td className="pt-0 pb-0 min-w-100">
                                <strong>Gender:</strong>
                              </td>
                              <td className="pt-0 pb-0">{patinetData?.gender}</td>
                            </tr>
                            <tr className="d-flex">
                              <td className="pt-0 pb-0 min-w-100">
                                <strong>Email:</strong>
                              </td>
                              <td className="pt-0 pb-0">{patinetData?.email}</td>
                            </tr>
                            <tr className="d-flex">
                              <td className="pt-0 pb-0 min-w-100">
                                <strong>Phone:</strong>
                              </td>
                              <td className="pt-0 pb-0">{patinetData?.contactNo}</td>
                            </tr>
                          </thead>
                        </table>
                      </div>
                ...
                <div className="WordSection1">
                    ...
                    ? consultaionData?.map((v) => {
                        return (
                          <p className="MsoNormal">
                            ...
                            >
                              {v?.position && "-"} {(v?.position)?.toLowerCase()}
                              &nbsp;
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      ...
                      dataReports?.orthopadic?.sottoHall?.lumbar.left ==
                        "Pos" ||
                      dataReports?.orthopadic?.sottoHall?.thoracic.left == "Pos"
                      ...
                      {!getdatareports(dataReports) &&
                      dataReports?.orthopadic?.lumborOrtho?.EYl?.right == "Pos"
                        ? `  EYl tests for ${
                            dataReports?.orthopadic?.lumborOrtho?.EYl
                              ?.rightOption?.SI
                              ? "sacroiliac pain"
                      ...
                      dataReports?.orthopadic?.lumborOrtho?.Yeoman?.right ==
                        ...
                        : ""}
                      {!getdatareports(dataReports) &&
                      dataReports?.orthopadic?.sottoHall?.lumbar.right == "Pos"
                        ? `  sottoHall lumbar tests  ,`
                        : ""}
                      {!getdatareports(dataReports) &&
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      ...
                      dataReports?.orthopadic?.deepTendon?.achills?.right
                        ?.value &&
                      !dataReports?.orthopadic?.deepTendon?.achills?.left?.value
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      ...
                      <p>
                        ...
                        dataReports?.orthopadic?.cervical?.MFC?.right ==
                          "Pos" &&
                        dataReports?.orthopadic?.cervical?.DIST?.right == "Neg"
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      ...
                      {dataReports?.diagnoses?.additionalDxs?.length ? (
                        ` ${dataReports?.diagnoses?.additionalDxs?.map((v) => {
                          return v.name ;
                        })}`
                      ) : (
                        <></>
                      ...
                      {dataReports?.diagnoses?.osteopathic?.length ? (
                        ` ${dataReports?.diagnoses?.osteopathic?.map((v) => {
                          return v.name ;
                        })}`
                      ) : (
                        <></>
                    ...
                    >
                      ...
                      {Boolean(Object?.keys(treatMan)?.length) && (
                        <span>
                          ...
                          followed by {dataReports?.treatments?.DC?.name + " "}{" "}
                          of those areas as needed.
                        </span>
                      )}
                      {Boolean(Object?.keys(treatImp)?.length) && (
                        <span>
                          ...
                          Imp muscle manipulation within the regions and of the
                          muscles affecting the
                          {treatMan &&
                            Object?.keys(treatImp)?.map((key) => (
                              <span key={key}> {key}, </span>
                            ))}
                          followed by {dataReports?.treatments?.HP?.name + " "}{" "}
                          of those areas as needed.
                        </span>
                      )}
                    </span>
                  ...
                  <br />
                  {dataReports?.treatments?.Kinesiotaping?.treatmentFrequency
                    ?.treatmentRight &&
                    dataReports?.treatments?.Kinesiotaping?.treatmentFrequency
                      ?.frequency &&
                    dataReports?.treatments?.Kinesiotaping?.treatmentFrequency
                      ...
                      <p className="MsoNormal">
                        ...
                        >
                          ...
                          {dataReports?.treatments?.Kinesiotaping
                            ?.treatmentFrequency?.treatmentRight + " "}
                          treatments per{" "}
                          {dataReports?.treatments?.Kinesiotaping
