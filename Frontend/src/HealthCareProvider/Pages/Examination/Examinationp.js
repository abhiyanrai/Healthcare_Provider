...
import {
  functionalFromApi, getAllPatientsDetails,
  getReportByIdApi,
  getSinglePatientDetailsById,
  updateFunctionalApi,
  getConsultationsApiById,
...
import { getExamTestApi, getScheduleDetailsApi } from "../../../Apis";
...
const Examinationp = () => {
  ...
  console.log(location, "fLLLLLfffff");
  ...
  // console.log(formik1.values, "sfdgsfdgdferffsdgfdsgdf");
  ...
  useEffect(() => {
    handleSelectChange(location?.state?.id);
  }, [location?.state?.id]);
    ...
    if (res.status === 200 || res.status === 201) {
      ...
      formik1.setValues((v) => ({
        ...
        Adams: {
          ...
          Lumb: {
            ...
            Deg: allData.LumbAdams?.position.Deg
              ? allData.LumbAdams?.position.Deg
              : "",
            Neg: allData.LumbAdams?.position.Neg,
          },
          Thor: {
            position: {
            ...
            Deg: allData.ThorAdams?.position?.Deg
              ? allData.ThorAdams?.position?.Deg
              : "",
            Neg: allData.ThorAdams?.position?.Neg,
          },
        },
      ...
      formik2.setValues((v) => ({
        ...
        deepTendon: {
          patellar: {
            left: {
              name: res?.data?.examination?.orthopadic?.lumborOrtho?.deepTendon
                ?.patellar?.left?.name,
              value:
                res?.data?.examination?.orthopadic?.lumborOrtho?.deepTendon
                  ?.patellar?.left?.value,
            },
            right: {
              value:
              ...
              <div className="col-12 text-center p-0 mt-3 mb-2">
                <div className=" card-header pt-0 ps-3 pe-3">
                  ...
                  <div className="row">
                    ...
                    <label className="me-2" htmlFor="date" style={{width: "100%", textAlign: "end"}}>Examination Date</label>
