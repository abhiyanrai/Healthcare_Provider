...
import {  getConsultationsApiByPatientId,
  getConsultationsApiById,
  getExaminationListById,
  getVisitDetailsApiById,
  updateSlotApiData,
  postSlotApiData,
  getAllAppontmentsApi,
  getServiceByIdApi, } from "../../../Apis/healthcareProvider";
  import { getVisitByPatintIdApi ,getExamTestApi } from "../../../Apis";
import { appointmentValidation } from "../../Components/Schemas";
import Diagnose from "../Examination/Diagnose";
