...
import { addSymptomApi, getOptionListApiById } from "../../../Apis";
import toast from "react-hot-toast";
import "react-toastify/dist/ReactToastify.css";
import { useNavigate } from "react-router-dom";
import { imageProfileApi } from "../../../Apis";
...
const AddSymptomForm = (props) => {
  ...
  const handleInputChange = (e, name) => {
    console.log(e.value, "JFKDISDFJSD");
  ...
  const handleAttachChange = async (e) => {
    ...
    setFileLoader(true);
    console.log(e.target.files[0].name?.split(".")[1], "DFDSFDSFDSFA");
    let c = e.target.files[0].name?.split(".")[1];
    if (c == "png" || c == "jpeg" || c == "jpg" || c == "pdf" || c == "svg") {
