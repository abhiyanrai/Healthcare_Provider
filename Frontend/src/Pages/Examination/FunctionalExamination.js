                    ...
                    <tr>
                      ...
                      <td>
                        <input
                          ...
                          value={formik1?.values?.Adams?.FixedSI?.BLT}
                      ...
                      <td>
                        <input
                          ...
                          value={formik1?.values?.Adams?.Lumb?.position?.left}
                      ...
                      <td>
                        <input
                          ...
                          value={formik1?.values?.Adams?.Lumb?.position?.right}
                          checked={
                      ...
                      <td>
                        <select
                          style={{ width: "inherit" }}
                          name="Adams.Lumb.Deg"
                          value={formik1?.values?.Adams?.Lumb?.Deg}
                      ...
                      <td>
                        <input
                          ...
                          type="checkbox"
                          name="Adams.Lumb.Neg"
                          value={formik1?.values?.Adams?.Lumb?.Neg}
                    ...
                    <tr>
                      ...
                      <td>
                        <input
                          ...
                          value={formik1?.values?.Adams?.Free?.position?.left}
                      ...
                      <td>
                        <input
                          ...
                          value={formik1?.values?.Adams?.Free?.position?.right}
                          checked={
                      ...
                      <td>
                        <input
                          ...
                          type="checkbox"
                          name="Adams.Free.BLT"
                          value={formik1?.values?.Adams?.Free?.BLT}
                      ...
                      <td>
                        <input
                          ...
                          value={formik1?.values?.Adams?.Thor?.position?.left}
                      ...
                      <td>
                        <input
                          ...
                          value={formik1?.values?.Adams?.Thor?.position?.right}
                          checked={
                      ...
                      <td>
                        <select
                          style={{ width: "inherit" }}
                          name="Adams.Thor.Deg"
                          value={formik1?.values?.Adams?.Thor?.Deg}
                          onChange={formik1.handleChange}
                          id=""
                        >
                          <option value="">Select</option>
                      ...
                      <td>
                        <input
                          ...
                          type="checkbox"
                          name="Adams.Thor.Neg"
                          value={formik1?.values?.Adams?.Thor?.Neg}
              ...
              <div className="table-responsive-md">
                <table className="table table-borderless tb_td">
                  <tbody>
                    ...
                    <tr>
                      {
                        console.log(formik1.values,"uerufdbjjfd")
                      }
                      <td colspan="8" className="text-dark font-weight-bold">
