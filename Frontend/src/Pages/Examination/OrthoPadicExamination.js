...
const OrthoPadicExamination = (props) => {
  ...
  const handleDeeps =(e,name,label,field)=>{
    formik2.setFieldValue(`deepTendonReflexes.${field}.${name}`,e.target.value)
    // formik2.setFieldValue("deepTendonReflexes.biceps.rightNew",)
    switch(e.target.value){
      case "0" :
        formik2.setFieldValue(`deepTendonReflexes.${field}.${label}`,"absent")
        break;
      case "1" :
        formik2.setFieldValue(`deepTendonReflexes.${field}.${label}`,"reduced")
        break;
      case "2" :
        formik2.setFieldValue(`deepTendonReflexes.${field}.${label}`,"normal")
        break;
      default :  
      formik2.setFieldValue(`deepTendonReflexes.${field}.${label}`,"hyperreflexiar")
        
    }
  }

  const handleElbowDeeps =(e,name,label,field)=>{
    formik2.setFieldValue(`deepTendon.${field}.${name}.value`,e.target.value)

    switch(e.target.value){
      case "0" :
        formik2.setFieldValue(`deepTendon.${field}.${name}.${label}`,"absent")
        break;
      case "1" :
        formik2.setFieldValue(`deepTendon.${field}.${name}.${label}`,"reduced")
        break;
      case "2" :
        formik2.setFieldValue(`deepTendon.${field}.${name}.${label}`,"normal")
        break;
      default :  
      formik2.setFieldValue(`deepTendon.${field}.${name}.${label}`,"hyperreflexiar")
        
    }
  }
console.log(formik2.values.deepTendonReflexes,"dppeieepppeiei")
                ...
                <tr>
                  ...
                  <td  colspan="3">
                    <select
                      ...
                      // onChange={formik2.handleChange}
                      onChange={(e)=>handleElbowDeeps(e,"left","name","patellar")}
                      id=""
                    >
                      <option value="" >select</option>
                  ...
                  <td colspan="3">
                    <select
                      ...
                      // onChange={formik2.handleChange}
                      onChange={(e)=>handleElbowDeeps(e,"right","name","patellar")}
                      id=""
                    >
                      <option value="" >select</option>
                      <option value="0">0</option>
                ...
                <tr>
                  ...
                  <td colspan="3">
                    <select
                      ...
                      // onChange={formik2.handleChange}
                      onChange={(e)=>handleElbowDeeps(e,"left","name","achills")}
                      id=""
                    >
                      <option value="" >select</option>
                      <option value="0">0</option>
                  ...
                  <td colspan="3">
                    <select
                      ...
                      // onChange={formik2.handleChange}
                      onChange={(e)=>handleElbowDeeps(e,"right","name","achills")}
                      id=""
                    >
                      <option value="" >select</option>
                      <option value="0">0</option>
                ...
                <tr>
                  ...
                  <td colspan="3">
                    <select
                      ...
                      // onChange={formik2.handleChange}
                      onChange={(e)=>handleDeeps(e,"left","leftNew","biceps")}
                      id=""
                    >
                      <option value="" >select</option>
                      <option value="0" >0</option>
                  ...
                  <td colspan="3">
                    <select
                      ...
                      // onChange={formik2.handleChange}
                      onChange={(e)=>handleDeeps(e,"right","rightNew","biceps")}
                      id=""
                    >
                      <option value="" >select</option>
                      <option value="0">0</option>
                ...
                <tr>
                  ...
                  <td colspan="3">
                    <select
                      ...
                      // onChange={formik2.handleChange}
                      onChange={(e)=>handleDeeps(e,"left","leftNew","triceps")}
                      id=""
                    >
                      <option value="" >select</option>
                      <option value="0">0</option>
                  ...
                  <td colspan="3">
                    <select
                      ...
                      // onChange={formik2.handleChange}
                      onChange={(e)=>handleDeeps(e,"right","rightNew","triceps")}
                      id=""
                    >
                      <option value="" >select</option>
                      <option value="0">0</option>
                ...
                <tr>
                  ...
                  <td colspan="3">
                    <select
                      ...
                      // onChange={formik2.handleChange}
                      onChange={(e)=>handleDeeps(e,"left","leftNew","brachiorad")}
                      id=""
                    >
                      <option value="" >select</option>
                      <option value="0">0</option>
                  ...
                  <td colspan="3">
                    <select
                      ...
                      // onChange={formik2.handleChange}
                      onChange={(e)=>handleDeeps(e,"right","rightNew","brachiorad")}
                      id=""
                    >
                      <option value="" >select</option>
                      <option value="0">0</option>
